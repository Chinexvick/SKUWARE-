...
export async function POST(req: NextRequest) {
  ...
  const { admissionNo, firstName, lastName, gender, dateOfBirth, classId, armId } = parsed.data;
  ...
  const student = await prisma.student.create({
    data: { schoolId, admissionNo, firstName, lastName, gender, dateOfBirth, classId, armId },
  });
